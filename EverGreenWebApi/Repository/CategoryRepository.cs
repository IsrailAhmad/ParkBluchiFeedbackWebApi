...
namespace EverGreenWebApi.Repository
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public IEnumerable<CategoryModel> GetAllCategoryList(int menuid,int storeid)
        {
            ...
            using (storefeedback_androidEntities context = new storefeedback_androidEntities())
            {
                ...
                var category = (from ms in context.menusetupmasters
                                ...
                                where ms.menuid == menuid && ms.StoreId == storeid
                                ...
                                select new CategoryModel()
                                {
                                    ...
                                    ProductData = (from msm in context.menusetupmasters
                                                   ...
                                                   where msm.menuid == menuid && msm.categoryid == j2.CategoryId && msm.StoreId == storeid
